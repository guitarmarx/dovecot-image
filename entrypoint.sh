...
sed -i "s|#user_filter.*|user_filter = (&(objectClass=posixAccount)(uid=%n))|g" $ldap_config
sed -i "s|#pass_filter.*|user_filter = (&(objectClass=posixAccount)(uid=%n))|g" $ldap_config
